...
public class EndPointUrls {
	...
	public static final String UPDATE_CUSTOMER = "http://localhost:9098/soapws/updateCustomerRequest";
	public static final String DELETE_CUSTOMER = "http://localhost:9098/soapws/deleteCustomerRequest";
