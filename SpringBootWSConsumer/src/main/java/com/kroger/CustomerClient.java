...
public class CustomerClient extends WebServiceGatewaySupport {
	public GetCustomerByIdResponse getCustomer(long customerId) {
		...
		return (GetCustomerByIdResponse) getWebServiceTemplate().marshalSendAndReceive(request,
				new SoapActionCallback(EndPointUrls.CUSTOMER_BY_ID));
	}

	public GetAllCustomerResponse getAllCustomers() {
		GetAllCustomerRequest request = new GetAllCustomerRequest();
		return (GetAllCustomerResponse) getWebServiceTemplate().marshalSendAndReceive(request,
				new SoapActionCallback(EndPointUrls.GET_ALL_CUSTOMER));
	}

	public AddCustomerResponse addCustomer(long customerId, String customerName, String customerCity,
			long customerPhone, long customerLoyalityPoint) {
		...
		return (AddCustomerResponse) getWebServiceTemplate().marshalSendAndReceive(request,
				new SoapActionCallback(EndPointUrls.ADD_CUSTOMER));
	}
	...
	public UpdateCustomerResponse updateCustomer(CustomerInfo customerInfo) {
		...
		return (UpdateCustomerResponse) getWebServiceTemplate().marshalSendAndReceive(request,
				new SoapActionCallback(EndPointUrls.UPDATE_CUSTOMER));
	}
	...
	public DeleteCustomerResponse deleteCustomer(long customerId) {
		...
		return (DeleteCustomerResponse) getWebServiceTemplate().marshalSendAndReceive(request,
				new SoapActionCallback(EndPointUrls.DELETE_CUSTOMER));
	}
}
