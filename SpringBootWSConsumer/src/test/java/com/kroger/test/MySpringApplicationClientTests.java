...
public class MySpringApplicationClientTests {
	...
	public void deleteCustomer() {
		...
		DeleteCustomerResponse response = customerClient.deleteCustomer(4331);
		assertEquals("200",response.getServiceStatus().getStatusCode());
	}
	...
	public void addCustomer() {
		...
		AddCustomerResponse response  = customerClient.addCustomer(4332, "Satish", "Hyd", Long.valueOf("9550510989"), 100);
		assertEquals("200",response.getServiceStatus().getStatusCode());
